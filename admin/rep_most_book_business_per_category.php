  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Most Book Business per Category</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Most Book Business per Category</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card-header">
              <form method="GET">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="barangay">Category:</label>
                    <select name="barangay" id="barangay" class="form-control">
                      <option value="">All</option>
                      <?php
                      $barangayQuery = $dbh->prepare("SELECT id, Category FROM tblcategory");
                      $barangayQuery->execute();
                      $barangays = $barangayQuery->fetchAll(PDO::FETCH_OBJ);
                      foreach ($barangays as $barangay) {
                          echo '<option value="' . $barangay->id . '"' . (isset($_GET['barangay']) && $_GET['barangay'] == $barangay->Category ? ' selected' : '') . '>' . $barangay->Category . '</option>';
                      }
                      ?>
                    </select>
                  </div>
                ...
                <div class="row mt-3">
                  <div class="col-md-12 text-right">
                    ...
                    <a href="rep_most_book_business.php" class="btn btn-secondary">Reset</a>
                  </div>
                </div>
              </form>
            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $sql = "SELECT 
                              ...
                              b.State,
                              c.Category,
                              COUNT(a.listing_id) AS reservation_count
                  ...
                  if (!empty($_GET['barangay'])) {
                      $sql .= " AND b.Category = :barangay";
                  }

                  $sql .= " GROUP BY b.ListingTitle, a.listing_id, b.State";
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlentities($row->reservation_count); ?></td>
                  </tr>
                  <?php $cnt++; }} ?>
                </tbody>
              </table>
      ...
      buttons: [
        {
          ...
          filename: function () {
            ...
            return `Most_Book_Business_per_category_Report_${formattedDate}_${formattedTime}`;
          },
