              ...
              <div class="row">
                ...
                <div class="row mt-3">
                  <div class="col-md-12 text-right">
                    ...
                    <a href="rep_list_of_business.php" class="btn btn-secondary">Reset</a>
                  </div>
                </div>
              </form>
            </div>
                ...
                <tbody>
                  ...
                  $sql = "SELECT 
                      ...
                      FROM 
                        tbllisting a
                      LEFT JOIN
                        tblcategory b ON b.ID = a.Category
                      WHERE
                        a.isDeleted = 0";

                  if (!empty($_GET['start_date']) && !empty($_GET['end_date'])) {
                    $sql .= " AND DATE(a.ListingDate) BETWEEN :start_date AND :end_date";
                  }
                  if (!empty($_GET['barangay'])) {
                      $sql .= " AND a.State = :barangay";
                  }

                  $sql .= " GROUP BY a.ListingTitle, a.State";
      ...
      buttons: [
        {
          ...
          filename: function () {
            ...
            return `List_of_business${formattedDate}_${formattedTime}`;
          },
