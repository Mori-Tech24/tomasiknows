...
<head>
  ...
  <title>TomasiKnows | Accepted Reviews</title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Accepted Reviews</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <?php
$sql="select tblreview.ID,tblreview.ListingID,tblreview.ReviewTitle,tblreview.Name,tblreview.DateofReview,tbllisting.ListingTitle from tblreview join tbllisting on tbllisting.ID=tblreview.ListingID where tblreview.Status='Review Accept'";
