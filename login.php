...
$mobnoValue = isset($_POST['mobno']) ? htmlspecialchars($_POST['mobno']) : '';
    ...
    if(strlen($mobno) != 11) {
        ...
        if($query->rowCount() > 0) {
            ...
            if($query->rowCount() > 0) {
                ...
                // Retain form data for invalid details error
                $mobnoValue = htmlspecialchars($mobno);
...
<head>
    ...
    <style>
        body {
            ...
            url('bg/pio.jpg') no-repeat center center fixed;
            ...
            <div class="login-box">
                ...
                <form name="login" method="post" onsubmit="return validateForm()">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mobno" id="mobno" required="true" maxlength="11" pattern="\d{11}" title="Mobile number must be exactly 11 digits" value="<?php echo $mobnoValue; ?>">
                    </div>
                    <div class="form-group">
                        <label for="password">Password:</label>
                        <input type="password" class="form-control" name="password" id="password" <?php echo $passwordValue; ?> required="true">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 d-flex justify-content-end">
                            <a href="admin/login.php">Login as Admin / Business Owner</a>
                        </div>
                    </div>
