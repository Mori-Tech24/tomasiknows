...
<head>
    ...
    <!-- Page Title -->
    <title>TomasiKnows || Contact Us</title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="address-box">
                                <span class="ti-location-pin text-primary"></span>
                                <?php
...
{               ?>
            ...
            <h2 class="text-center pt-5 mb-5">Send us a Message</h2>
                        ...
                        <div class="col-md-12">
                            <div class="contact-form pl-4 py-4">
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                       <button type="submit" 
        style="background-color:#007AFF; color:white; border-color:#007AFF; transition: all 0.3s ease;" 
        class="btn-submit" 
        id="js-contact-btn" 
        name="submit">
  SEND MESSAGE
...
<style>
  ...
  #js-contact-btn:active {
    filter: brightness(0.9);  /* Slightly darkens when clicked */
  }
</style>
